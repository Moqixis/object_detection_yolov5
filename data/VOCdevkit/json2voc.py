...
# 1.存放的json标签路径
labelme_path = "./mycode/test3/data/VOCdevkit/labels/"

# 原始labelme标注数据路径
saved_path = "mycode/test3/data/VOCdevkit/VOC2007/"
# 保存路径
...
for json_file_ in files:
    ...
    height, width, channels = cv2.imread('./mycode/test2/VOCdevkit/images/' + json_file_ + ".jpg").shape
...
image_files = glob("./mycode/test2/VOCdevkit/images/" + "*.jpg")
