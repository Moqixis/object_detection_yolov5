...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            gn = torch.tensor(im0.shape)[[1, 0, 1, 0]]  # normalization gain whwh , gn = [w, h, w, h]  用于后面的归一化
            imc = im0.copy() if save_crop else im0  # for save_crop , 在save_crop中使用
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp/weights/best.pt', help='model path(s)') # 修改
